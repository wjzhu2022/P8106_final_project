...
pls.rmse = sqrt(mean((pls.pred - y2)^2))
pls.rmse
```
...
test_error_svm=mean((test_pred_svm - dat$recovery_time[-train_index])^2)
```
...
test_rmse <- c(lm.rmse, ridge.rmse, rmse_lasso, enet.rmse, pcr.rmse, pls.rmse, rmse_gam, rmse_mars, rmse_tree, rmse_rf, rmse_gbm,test_error_svm)
