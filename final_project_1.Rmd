...
lasso.rmse = sqrt(mean((pred_lasso - y2)**2))
lasso.rmse
...
```{r}
model <- c("LM","RIDGE","LASSO","ENET","PCR","PLS","GAM","MARS")
test_rmse <- c(lm.rmse, ridge.rmse, lasso.rmse, enet.rmse, pcr.rmse, pls.rmse, rmse_gam, rmse_mars, rmse_tree)
