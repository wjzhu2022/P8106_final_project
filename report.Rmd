...
Among all the eleven models, according to Figure 3 and Table 1, the boosting model have the smallest mean and median RMSE, so it was the final model selected with the best performance in the primary analysis. Thus,  the final model to predict the recovery time from COVID-19 was the GAM model.
