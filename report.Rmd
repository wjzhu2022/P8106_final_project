...
```{r,echo=FALSE,out.width='90%',out.height='70%',fig.align='center'}
knitr::include_graphics("secondary_analysis_plot/accuracy.png")
```
\begin{center}
...
```{r,echo=FALSE,out.width='90%',out.height='70%',fig.align='center'}
knitr::include_graphics("primary_analysis_plot/svm_plot.png")
```
\begin{center}
Appendix XI. SVM
\end{center}
...
```{r,echo=FALSE,out.width='90%',out.height='70%',fig.align='center'}
knitr::include_graphics("secondary_analysis_plot/linear.png")
```
\begin{center}
Appendix XII. Linear model
\end{center}

```{r,echo=FALSE,out.width='90%',out.height='70%',fig.align='center'}
knitr::include_graphics("secondary_analysis_plot/lasso.png")
```
\begin{center}
Appendix XIII. Lasso
\end{center}
...
```{r,echo=FALSE,out.width='90%',out.height='70%',fig.align='center'}
knitr::include_graphics("secondary_analysis_plot/elastic_net.png")
```
\begin{center}
Appendix XIIII. Elastic net
\end{center}

```{r,echo=FALSE,out.width='90%',out.height='70%',fig.align='center'}
knitr::include_graphics("secondary_analysis_plot/pcr.png")
```
\begin{center}
Appendix XV. PCR
\end{center}
...
```{r,echo=FALSE,out.width='90%',out.height='70%',fig.align='center'}
knitr::include_graphics("secondary_analysis_plot/mars.png")
```
\begin{center}
Appendix XVI. MARS
\end{center}
...
```{r,echo=FALSE,out.width='90%',out.height='70%',fig.align='center'}
knitr::include_graphics("secondary_analysis_plot/ridge.png")
```
\begin{center}
Appendix XVII. Ridge
\end{center}
...
```{r,echo=FALSE,out.width='90%',out.height='70%',fig.align='center'}
knitr::include_graphics("secondary_analysis_plot/gam.png")
```
\begin{center}
Appendix XVIII. GAM
\end{center}
